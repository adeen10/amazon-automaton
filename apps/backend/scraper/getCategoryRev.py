...
#     # find the Amazon tab that actually has the XRAY overlay visible
#     page = None
...
#     # --- click 'Load More' robustly ---
#     clicked = False
#     # prefer role/text over classes which change often
...
#     except:
#         # fallback: try the class selector you saw
#         try:
