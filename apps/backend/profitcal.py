...
#     # Step 2: Wait for Helium 10 panel's calculator button to appear and click
#     calculator_button = amazon_page.locator('div[data-testid="calculator"]')
#     calculator_button.wait_for(state="visible", timeout=15000)
#     calculator_button.click()
#     print("[info] Clicked Helium 10 Profitability Calculator button.")

   
    
#     # Step 4: Wait for required elements
#     selectors = {
#         "fba_fees": 'div.sc-gsnOKb.jESxTP',
...
#         # "product_price_currency": 'div.sc-kdYKFS.lgKsUy"]',
#         "product_price": 'input[data-testid="calculator-profitability-price"]'
#     }

#     for name, sel in selectors.items():
#         try:
#             amazon_page.wait_for_selector(sel, timeout=30000)
#         except:
#             print(f"[ERROR] Could not find selector for {name}: {sel}")
#             print("[DEBUG HTML]", amazon_page.content())
#             exit()

#     # Step 5: Extract values
#     fba_fees = amazon_page.locator(selectors["fba_fees"]).inner_text().strip()
#     storage_fee_jan_sep = amazon_page.locator(selectors["storage_fee_jan_sep"]).inner_text().strip()
#     storage_fee_oct_dec = amazon_page.locator(selectors["storage_fee_oct_dec"]).inner_text().strip()
#     product_price = amazon_page.locator(selectors["product_price"]).input_value().strip()
#     # product_price_currency = amazon_page.locator(selectors["product_price_currency"]).inner_text().strip()

#     print("FBA Fees:", fba_fees)
#     print("Storage Fee Jan-Sep:", storage_fee_jan_sep)
#     print("Storage Fee Oct-Dec:", storage_fee_oct_dec)
#     print("Product Price:", product_price)
#     # print("Product Price Currency:", product_price_currency)

#     input("Press Enter to exit…")

#     # # Step 4: Read required values
#     # storage_fee_jan_sep = fba_page.locator('div[data-testid="calculator-profitability-storageFeeJanSep"]').inner_text().strip()
    
#     # product_price = fba_page.locator('input[data-testid="calculator-profitability-price"]').input_value().strip()
...
#     # fba_page.wait_for_selector('div.sc-gsnOKb.jESxTP', timeout=15000)
#     # fba_fees = fba_page.locator('div.sc-gsnOKb.jESxTP').inner_text().strip()
#     # print("FBA Fees:", fba_fees)
