...
FILLED_COLS = [
    ...
    COL_YOUR_COMPETITOR, COL_COMP_MREV, COL_YOUR_PRICE, COL_FBA_FEES,
                        ...
                        "products": [
                            {
                                ...
                                "result": {
                                    ...
                                    "gpt_projection": {
                                        "response": {"low_total_sales": 63, "base_total_sales": 96, "high_total_sales": 135}
                                    }
                                }
                            },
                            {
                                ...
                                "result": {
                                    ...
                                    "gpt_projection": {
                                        "response": {"low_total_sales": 225, "base_total_sales": 343, "high_total_sales": 483}
                                    }
                                }
                            }
                        ]
